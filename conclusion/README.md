...
- Scientists (mathematicians, physicists, and chemists) extend our understanding of reality through explorations
- Hardware vendors (Intel-like) follow scientific discoveries and build hardware obeying laws of nature
- Programming language designers create toolchains for software engineers
- Software engineers implement domain-specific models guided by business requirements
...
- Changes in programming language designs are triggering changes in how software engineers write/organize code
...
without burdening "software engineers"
